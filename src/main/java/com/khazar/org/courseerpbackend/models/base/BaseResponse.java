package com.khazar.org.courseerpbackend.models.base;
...
import static com.khazar.org.courseerpbackend.models.enums.response.SuccessResponseMessages.SUCCESS;
    ...
    public static final class Meta {
        ...
        public static Meta of(BaseException ex) {
            ...
            if (ex.getResponseMessage().equals(NOT_FOUND)) {
                ...
                return of(String.format(ex.getResponseMessage().key(), notFoundData.getTarget().toLowerCase()),
